...
#'
#'@usage costDistance(dem.peaklist,ext.peaklist)
...
#'
#'@return costDistance returns one merged peaklist with the names of the external peaks and the coords and altitude from the DEM derived list
#'
#'@export costDistance
#'@examples
...
#'
#'       new.peaklist<-costDistance(dem.peaklist,ext.peaklist)


costDistance<- function(pointList, costraster, domthres,plots=TRUE){
